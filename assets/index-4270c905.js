(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(e){if(e.ep)return;e.ep=!0;const n=o(e);fetch(e.href,n)}})();function s(){document.querySelector("div.main header").innerHTML=`
    <form>
      ...
      `,d()}function u(){const t=new Date,r=String(t.getDate()).padStart(2,"0"),o=String(t.getMonth()+1).padStart(2,"0");return`${t.getFullYear()}-${o}-${r}`}function d(){const t=document.getElementById("input-date");t.max=u()}const l="/api-nasa/assets/cat-64b6116b.jpg",m=window.location.search,f=new URLSearchParams(m),c=f.get("date"),p="9d3ii44W8GRaQvkghYy3Om9cRI7Chb3ZQM8jx1d0";function h(){c?fetch(`https://api.nasa.gov/planetary/apod?date=${c}&api_key=${p}`).then(t=>t.json()).then(t=>{if(t.code===400)throw Error(t.msg);const{title:r,date:o,hdurl:a,explanation:e}=t;document.querySelector("div.main section").innerHTML=`
        <h1>${r}</h1>
        <h2>${o}</h2>
        <img src=${a}>
        <p>${e}</p>
